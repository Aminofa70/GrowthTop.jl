...
using GrowthTop
# done!
### Topology Optimization Cantilever based on Ttwo - type  formulation
...
# η = [π/(2.5) , π /(3.5) , π/(4.0)]               # Filter parameter
# B_Δt = [ 0.1, 1, 10]                     # Sensitivity parameter
# vf =[0.0, 0.25, 0.5, 0.75]                   # Volume fraction

γ = 1                   # Penalty factor
η =  π/(3.5)               # Filter parameter
B_Δt = 1.0                    # Sensitivity parameter
volfrac = 0.75                  # Volume fraction
...
top_2d(Ttwo , par, E, B_Δt, γ, η ,volfrac,  file_name, dir)